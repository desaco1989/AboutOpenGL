package com.desaco.aboutopengl.vr;
...
public class VRdoubleEyesActivity extends Activity implements GLSurfaceView.Renderer, SensorEventListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mGLView = (GLSurfaceView) findViewById(R.id.vr_glview);
