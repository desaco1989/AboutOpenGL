 ...
 * 3D 贴图
 *
 * OpenGL是独立于视窗操作系统或其它操作系统的，亦是网络透明的。在包含CAD、内容创作、能源、娱乐、游戏开发、制造业、制药业及虚拟现实等行业领域中，
 * OpenGL帮助程序员实现在 PC、工作站、超级计算机等硬件设备上的高性能、极具冲击力的高视觉表现力图形处理软件的开发。
 *
 * https://blog.csdn.net/fukaimei/article/details/78154520?locationNum=7&fps=1
 *
 * Created by desaco on 2018/5/7.
 */
public class Texture3DStickerActivity extends Activity implements OnGestureListener {
    //
    // 定义旋转角度
